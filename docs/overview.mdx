...
This impact should include the embodied emissions from manufacturing the hardware, the emissions from the energy used while operating hardware, and the water impact from cooling the datacenters.
