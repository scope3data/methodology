...
- Input granularity match rate (0-100) - % of fields that are provided and match a modeled entity
...
## Match rate and input granularity
...
Match rate is the % of input fields that map to a granular model entity.
