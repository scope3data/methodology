...
| Property Metrics                | Example Data Source             | Model Quality |
| ------------------------------- | ------------------------------- | ------------- |
| Not available                   | N/a                             | 1             |
...
Each key metric’ model quality is evaluated separately, then the property’ model quality score is the lower closest integer (floor) of the sum of each key metric’ model quality score divided by 3.

Example:
| Metric | Example Data Source | Model Quality |
| ----------------- | ----------------------| ------------- |
| Session time | SimilarWeb | 3 |
| Session weight | SimilarWeb | 3 |
| Ad load | Publisher’ Google Ad Manager account | 5 |

Property model quality score: (3+3+5) / 3 = 3.67 ⇒ 3
