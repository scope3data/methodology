...
For web, app, social, CTV and digital audio media properties, key metrics include session time, session weight, and ad load.
An observed or measured metric is acquired on a per-property basis - for instance, using SimilarWeb or the publisher's own Google Analytics. An estimated or average metric is derived from publicly available information such as financial reports.

| Property Metrics      | Geography | Model Quality |
| --------------------- | --------- | ------------- |
| Not available         | N/a       | 1             |
| Average or estimated  | N/a       | 2             |
| Observed by 3rd party | Global    | 3             |
| 1st party measured    | Global    | 4             |
| 1st party measured    | Regional  | 5             |
...
| Property Metrics                                         | Granularity       | Model Quality |
| -------------------------------------------------------- | ----------------- | ------------- |
| Not available                                            | N/a               | 1             |
