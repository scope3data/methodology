...
Account for non-required fields:
...
```
  ...
  average_dynamic_watts_per_kbps =
      default_dynamic_watts_per_kbps['mobile'] x pct_mobile +
      default_dynamic_watts_per_kbps['fixed'] x (1 - pct_mobile)
  ...
  dynamic_watts_per_kbps =
      network_type ?
      default_dynamic_watts_per_kbps[network_type] :
      average_dynamic_watts_per_kbps

  channel = channel ? default_channel_by_device[device_type]
