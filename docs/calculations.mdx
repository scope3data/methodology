...
| Field                                           | Description |
| ----------------------------------------------- | ------------------------------------------------------------ |
| `average_seconds_per_session_ex_ads`            | The average length of a session on this property excluding ads (eg 44 min of a 60 min TV show) |
| `average_imps_per_session`                      | The average number of impressions per session |
| `average_data_kb_per_session_ex_ads`            | The average number of KB transferred during a session excluding ads |
| `ad_funded_percentage`                          | The percentage of content funded by advertising (eg 50%) |
...
| `total_decisioning_requests`                    | Total decisioning requests handled |
...
ad_selection_emissions_gco2pm = 0
  for platform in placement.ad_platforms:
      ad_selection_emissions += get_platform_emissions(platform)
```
