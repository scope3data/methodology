...
```
  ...
  average_dynamic_watts =
      default_dynamic_watts['mobile'] x pct_mobile +
      default_dynamic_watts['fixed'] x (1 - pct_mobile)
  ...
  dynamic_watts =
      network_type ?
      default_dynamic_watts[network_type] :
      average_dynamic_watts
...
power =
    baseload_watts +
    dynamic_watts x default_video_bitrate[device_type]
