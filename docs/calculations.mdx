...
Emission factors from [GMSF 1.2](https://adnetzero.com/wp-content/uploads/2025/06/GlobalMediaSustainabilityFrameworkV1.2.pdf), along with assumptions on average distribution per storage type and default impressions per creative, are used to allocate the storage emissions of creative materials (also called the master bundle).
