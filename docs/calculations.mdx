...
audio_bytes = audio_duration_seconds x default_audio_bitrate_kbps[device_type]
...
power_watts =
    baseload_watts +
    dynamic_watts_per_mbps x default_video_bitrate_kbps[device_type] / 1000
...
creative_data_transfer_embodied_emissions_gco2pm =
      ...
      default_video_bitrate_kbps[device_type] / 128 x
      embodied_emissions_gco2e_per_kb
```
